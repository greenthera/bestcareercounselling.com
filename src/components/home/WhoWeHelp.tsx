...
import { ArrowUpRight, GraduationCap, Landmark, ClipboardList, Briefcase, Globe, Repeat, Sprout } from 'lucide-react'
    ...
    <section className="px-4 py-8 md:px-8">
      <div className="mx-auto max-w-7xl rounded-[2rem] bg-green-tint px-6 py-14 md:px-10 md:py-16">
        <Reveal>
          ...
          <p className="mt-2 text-center text-sm text-muted-ink">Seven ways we help, one conversation to start.</p>
        </Reveal>
            ...
            {services.map((service, index) => {
              ...
              return (
                <Link
                  ...
                  className={cn(
                    'group flex items-center gap-3 rounded-2xl border border-neutral-border bg-white p-4',
