...
const SECTIONS: LegalSection[] = [
  {
    ...
    paragraphs: [
      'Best Career Counselling ("we", "us", "our") provides career counselling, psychometric assessment and admission consulting services to students, parents and working professionals across Gujarat. This policy explains what information we collect, why we collect it, and how it is used.',
    ],
  },
  {
  ...
  },
  {
    ...
    paragraphs: [
      'We use your information to respond to enquiries, schedule and conduct consultations, deliver assessment reports, provide counselling and admission support, and share relevant updates about your booking.',
      "We do not use your information for purposes unrelated to the services you've requested.",
    ],
  },
  {
  ...
  },
  {
    ...
    paragraphs: [
      'We take reasonable technical and organisational measures to protect your information from unauthorised access, loss or misuse. No method of transmission over the internet is completely secure, and we cannot guarantee absolute security.',
    ],
  },
  {
  ...
  },
  {
    heading: '7. Cookies',
    paragraphs: [
      'Our website may use basic cookies to remember your preferences and understand site usage. You can disable cookies in your browser settings, though some features may not work as intended.',
    ],
  },
  {
