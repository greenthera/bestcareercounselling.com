...
const SECTIONS: LegalSection[] = [
  {
    ...
    paragraphs: [
      'By booking a consultation, taking an assessment, or otherwise using our services, you agree to these Terms. If you do not agree with any part of these Terms, please do not use our services.',
    ],
  },
  {
  ...
  },
  {
    ...
    paragraphs: [
      'The initial 15-minute consultation call is free of charge. Paid services, such as assessments and admission consulting packages, are confirmed only after payment or an agreed arrangement is in place.',
    ],
  },
  {
    heading: '4. User responsibilities',
    paragraphs: [
      'You agree to provide accurate and complete information during consultations and assessments. Recommendations are only as reliable as the information provided.',
    ],
  },
  {
  ...
  },
  {
    ...
    paragraphs: ['These Terms are governed by the laws of India, with courts in Surat, Gujarat having jurisdiction.'],
  },
  {
